...
def create_app():
    ...
    # Very strict threshold for VGG-Face model (cosine distance): 0.20 means faces must be 80%+ similar
    # Lower threshold = stricter matching, preventing false positives
    # This ensures only the actual registered voter can authenticate
    app.config['FACE_THRESHOLD'] = float(os.environ.get('FACE_THRESHOLD', '0.20'))
