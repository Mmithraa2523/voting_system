...
def create_app():
    ...
    # Configuration
    app.config['SECRET_KEY'] = os.environ.get('SECRET_KEY', 'bdb6766f351e0a56669f4385007a2362a72e50f1068dd4d4efcc5d1f6009217f')
    ...
    app.config['MAIL_PASSWORD'] = os.environ.get('EMAIL_APP_PASSWORD', 'trqc subs fkim wbrp')
...
if __name__ == '__main__':
    ...
    # Use 127.0.0.1 for local development, 0.0.0.0 for Replit
